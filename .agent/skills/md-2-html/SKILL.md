...
- **容器背景**: 高透白色毛玻璃 
gba(255, 255, 255, 0.85) + ackdrop-filter: blur(10px)
- **主要文字**: 深灰 #1f2937
...
- **容器 (Container)**:
    ...
    - ont-family: 'Noto Sans SC', sans-serif

- **区块 (Sections)**:
    - 统一内边距: padding: 40px 50px
    - 分割线: order-bottom: 1px solid rgba(167, 139, 250, 0.2)
...
- **单元格**: 白色背景，偶数行浅紫 
gba(245, 243, 255, 0.5)
- **圆角**: 表格整体 order-radius: 12px，overflow: hidden

#### 详情卡片 (Details)
- **序号球**: 32px 圆形，紫色渐变背景，白字
- **元数据框**: 浅色背景块 linear-gradient(135deg, #faf5ff 0%, #f3e8ff 100%)，左侧紫色竖线装饰
- **列表**: 实心圆点 • (紫色)
- **标签**: order-radius: 20px，带 emoji 前缀 (如 🎙️)

#### 截图展示
- 图片圆角 12px
- 阴影 ox-shadow: 0 8px 30px rgba(139, 92, 246, 0.2)
- 边框 1px solid #e9d5ff
...
- **副标题 (Slogan)**:
    1. 第一行: 普通深灰色说明
    2. 第二行: **胶囊样式** (Capsule Style) -> order-radius: 30px, 淡紫背景, 深紫文字, display: inline-block, margin-bottom: 50px (大间距)
- **二维码**:
    - 单图居中展示
...
<html lang="zh-CN">
<head>
    <!-- Meta & Styles & Google Fonts (Noto Sans SC) -->
</head>
<body>
    <div class="container">
        <!-- 1. Header -->
        <header class="header">
            <div class="logo-container">
                ...
                <span class="main-title-inline">YYYY/MM/DD 硅谷AI圈动态</span>
            </div>
        ...
        <footer class="footer">
            <div class="qr-section">
                <h3>✨ 加入「小禾AI交流群」</h3>
                <p class="qr-subtitle">扫码加入群聊，群内每日更新《今日硅谷AI圈动态》</p>
                <p class="qr-subtitle">每天 5 分钟，第一时间了解硅谷 AI 大佬在 X 上的最新讨论</p>
                <div class="qr-grid">
                    <div class="qr-item">
                        <div class="qr-image">
                            <!-- Update with latest QR asset if needed -->
...
i_posts_summary_YYYY-MM-DD-ghc.html
